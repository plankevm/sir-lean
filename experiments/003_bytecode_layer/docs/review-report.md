...
[`messageCall_call_runs`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L122): a caller
...
[`drive_descend_eq`](../../../EVM/BytecodeLayer/Semantics/Interpreter/DescentEq.lean#L153).
...
Observables are deliberately narrow ([`Observables.lean`](../../../EVM/BytecodeLayer/Observables.lean)):
the world-independent [`Observables`](../../../EVM/BytecodeLayer/Observables.lean#L24)
(`success`, `output`), the single-cell reader
[`CallResult.storageAt`](../../../EVM/BytecodeLayer/Observables.lean#L49), and the named
[`Outcome`](../../../EVM/BytecodeLayer/Observables.lean#L72)
...
| File | Layer | Role |
|---|---|---|
| [`Semantics/UInt64.lean`](../../../EVM/BytecodeLayer/Semantics/UInt64.lean) | leaf | the one `toNat_sub_ofNat` gas-threading arith fact |
| [`Semantics/Maps.lean`](../../../EVM/BytecodeLayer/Semantics/Maps.lean) | leaf | `find?`/`findD` framing equations for the SSTORE storage reads |
| [`Semantics/Gas.lean`](../../../EVM/BytecodeLayer/Semantics/Gas.lean) | leaf | per-step gas decrease (`stepFrame_next_lt`); the 63/64 floor (`liftFloor`); CALL/CREATE own-cost lower bounds |
| [`Semantics/Precompiles.lean`](../../../EVM/BytecodeLayer/Semantics/Precompiles.lean) | leaf | precompile gas bounds (the `*_gas_le`, `beginCall_inr_gas`) |
| [`Semantics/Dispatch.lean`](../../../EVM/BytecodeLayer/Semantics/Dispatch.lean) | leaf | `stepFrame`/`dispatch` signal-shape inversions (`onlyNext`, systemOp bridges) |
| [`Semantics/System.lean`](../../../EVM/BytecodeLayer/Semantics/System.lean) | mid | CALL/CREATE/halt/resume machinery: `stepFrame_call`, `EntersAsCode`, `beginCall_*`, `resumeAfter*` gas bounds, `systemOp_*` descent/fallback inversions |
| [`Semantics/Interpreter/Drive.lean`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Drive.lean) | mid | `drive` vocabulary + fuel monotonicity (`drive_step/halt`, `driveG_*`, `drive_fuel_mono`, `messageCall_eq_drive`) |
| [`Semantics/Interpreter/Measure.lean`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Measure.lean) | mid | the measure `μ`, `mu_bound` (modulo `gasFundsDescent`), boundary theorem |
| [`Semantics/Interpreter/NeverOutOfFuel.lean`](../../../EVM/BytecodeLayer/Semantics/Interpreter/NeverOutOfFuel.lean) | **headline** | discharges `gasFundsDescent_holds`; unconditional `messageCall_never_outOfFuel` |
| [`Semantics/Interpreter/DescentEq.lean`](../../../EVM/BytecodeLayer/Semantics/Interpreter/DescentEq.lean) | mid | generic CALL-boundary decomposition `drive_append_framing` → `drive_descend_eq` |
| [`Hoare.lean`](../../../EVM/BytecodeLayer/Hoare.lean) | mid | `StepsTo`/`Runs`/`Runs.trans`; `Runs.drive_advance`; opcode rules; SSTORE effect/frame |
| [`Hoare/Behaves.lean`](../../../EVM/BytecodeLayer/Hoare/Behaves.lean) | leaf | the for-all-programs `Behaves` predicate — **defined but unconsumed** (see §7) |
| [`Hoare/Sequence.lean`](../../../EVM/BytecodeLayer/Hoare/Sequence.lean) | leaf | `subCharges`/`toNat_subCharges` gas-threading; `seqProgram` decode facts |
| [`Hoare/OutcomeBridge.lean`](../../../EVM/BytecodeLayer/Hoare/OutcomeBridge.lean) | leaf | `ofCall_completed_of_success` (raw `.ok` → named `Outcome.completed`) |
| [`Hoare/CallSequence.lean`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean) | **headline** | `drive_eq_of_both_ne_oof`, `messageCall_runs`, `CallReturns`, `messageCall_call_runs`, `messageCall_call_completedWith` |
| [`ExternalCall.lean`](../../../EVM/BytecodeLayer/ExternalCall.lean) | example support | caller/callee fixtures, `childGas`/`childGas_lb`, decode facts, `final_obs`, `call_counterexample` proof |
| [`Programs.lean`](../../../EVM/BytecodeLayer/Programs.lean) | data | the handwritten bytecode contracts and `CallParams` entry points |
| [`Examples/ProgramDecode.lean`](../../../EVM/BytecodeLayer/Examples/ProgramDecode.lean) | example | per-pc `decode` facts for the call-free programs |
| [`Examples/ProgramExamples.lean`](../../../EVM/BytecodeLayer/Examples/ProgramExamples.lean) | example | the call-free `*'` observe/storage lemmas (composed from opcode rules) |
| [`Examples/HoareDemo.lean`](../../../EVM/BytecodeLayer/Examples/HoareDemo.lean) | example | standalone compositional demo on `sstoreProgram` (`hoare_demo`) |
| [`Examples/CallerProgExample.lean`](../../../EVM/BytecodeLayer/Examples/CallerProgExample.lean) | example | compositional instantiation of `messageCall_call_runs` on caller/callee |
| [`Examples/ConcreteSpecs.lean`](../../../EVM/BytecodeLayer/Examples/ConcreteSpecs.lean) | example | per-program observable specs; the `∃G₀` `messageCall_call_storageAt` |
| [`Spec.lean`](../../../EVM/BytecodeLayer/Spec.lean) | **audit surface** | re-exports the general program-logic + external-CALL rules |
...
[`messageCall_call_runs`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L122):
...
[`CallReturns`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L99):
...
Supporting types:
[`EntersAsCode`](../../../EVM/BytecodeLayer/Semantics/System.lean#L237) is
`abbrev EntersAsCode (p : CallParams) (fr : Frame) : Prop := beginCall p = .inl fr`;
[`Runs`](../../../EVM/BytecodeLayer/Hoare.lean#L86) is the `Nat`-indexed reflexive-transitive
...
[`messageCall_call_completedWith`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L214),
...
([`Measure.lean`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Measure.lean#L77)):
...
with the kind-aware [`Pending.savedGas`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Measure.lean#L53)
(subtracts the forwarded `allButOneSixtyFourth` for an open CREATE descent to avoid
double-counting). The general bound
[`mu_bound`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Measure.lean#L129) (`μ ≤ f →
drive f … ≠ OutOfFuel`, by induction on `f`) is parametric over the one fact the
induction cannot supply generically,
[`gasFundsDescent`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Measure.lean#L103) — five
...
[`gasFundsDescent_holds`](../../../EVM/BytecodeLayer/Semantics/Interpreter/NeverOutOfFuel.lean#L151),
...
[`drive_append_framing`](../../../EVM/BytecodeLayer/Semantics/Interpreter/DescentEq.lean#L57)
...
[`drive_eq_of_both_ne_oof`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L46): two
terminating `drive` runs over the same stack/state at fuels `a`, `b` agree (the
larger reduces to the smaller by
[`drive_fuel_mono`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Drive.lean#L187)). This
is how the large-fuel run is brought back to `seedFuel p.gas`.

### 4.5 Mid — the intra-frame boundary bridge and sequencing rule

[`Runs.trans`](../../../EVM/BytecodeLayer/Hoare.lean#L97) is the sequencing rule (glue two
blocks, never name a trace). The single-frame boundary bridge
[`messageCall_runs`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L68) crosses to
...
[`liftFloor`](../../../EVM/BytecodeLayer/Semantics/Gas.lean#L626) and
[`allButOneSixtyFourth_ge_of_liftFloor_le`](../../../EVM/BytecodeLayer/Semantics/Gas.lean#L628):
...
[`childGas_lb`](../../../EVM/BytecodeLayer/ExternalCall.lean#L187)). The floor is *derived*,
not magic.

### 4.7 The audit surface

[`Spec.lean`](../../../EVM/BytecodeLayer/Spec.lean) re-exports
[`Runs.trans`](../../../EVM/BytecodeLayer/Spec.lean#L50),
[`messageCall_runs`](../../../EVM/BytecodeLayer/Spec.lean#L58), the opcode rules,
[`CallReturns`](../../../EVM/BytecodeLayer/Spec.lean#L155),
[`messageCall_call_runs`](../../../EVM/BytecodeLayer/Spec.lean#L164), and
[`messageCall_call_completedWith`](../../../EVM/BytecodeLayer/Spec.lean#L180). The file's own
...
a [`Maps.lean`](../../../EVM/BytecodeLayer/Semantics/Maps.lean) docstring). Axioms (re-run via
a `lake env lean` scratch, now deleted):

| Symbol | Axioms |
|---|---|
| [`messageCall_call_runs`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L122) | `[propext, Classical.choice, Quot.sound]` |
| [`messageCall_call_completedWith`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L214) | `[propext, Classical.choice, Quot.sound]` |
| [`messageCall_never_outOfFuel`](../../../EVM/BytecodeLayer/Semantics/Interpreter/NeverOutOfFuel.lean#L158) | `[propext, Classical.choice, Quot.sound]` |
| [`mu_bound`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Measure.lean#L129) | `[propext, Classical.choice, Quot.sound]` |
| [`gasFundsDescent_holds`](../../../EVM/BytecodeLayer/Semantics/Interpreter/NeverOutOfFuel.lean#L151) | `[propext, Classical.choice, Quot.sound]` |
| [`drive_descend_eq`](../../../EVM/BytecodeLayer/Semantics/Interpreter/DescentEq.lean#L153) | `[propext, Classical.choice, Quot.sound]` |
| [`messageCall_runs`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L68) | `[propext, Classical.choice, Quot.sound]` |
| [`Runs.trans`](../../../EVM/BytecodeLayer/Hoare.lean#L97) | `[propext, Classical.choice, Quot.sound]` |
| [`messageCall_call_storageAt`](../../../EVM/BytecodeLayer/Examples/ConcreteSpecs.lean#L95) | `[propext, Classical.choice, Quot.sound]` |
| [`messageCall_callerProg_storageAt`](../../../EVM/BytecodeLayer/Examples/CallerProgExample.lean#L218) | `[propext, Classical.choice, Quot.sound]` |
| [`call_counterexample`](../../../EVM/BytecodeLayer/Examples/ConcreteSpecs.lean#L106) | `[propext, Classical.choice, Quot.sound]` |

**Headline / mainline**
- [`messageCall_call_runs`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L122) and its
  observable wrapper [`messageCall_call_completedWith`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L214).
- [`messageCall_never_outOfFuel`](../../../EVM/BytecodeLayer/Semantics/Interpreter/NeverOutOfFuel.lean#L158).

**Supporting lemmas (bricks)**
- Measure: [`mu_bound`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Measure.lean#L129),
  [`gasFundsDescent_holds`](../../../EVM/BytecodeLayer/Semantics/Interpreter/NeverOutOfFuel.lean#L151)
  + its five conjuncts.
- Descent: [`drive_append_framing`](../../../EVM/BytecodeLayer/Semantics/Interpreter/DescentEq.lean#L57)
  → [`drive_descend_eq`](../../../EVM/BytecodeLayer/Semantics/Interpreter/DescentEq.lean#L153).
- Fuel: [`drive_fuel_mono`](../../../EVM/BytecodeLayer/Semantics/Interpreter/Drive.lean#L187),
  [`drive_eq_of_both_ne_oof`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L46).
- Per-step gas: [`stepFrame_next_lt`](../../../EVM/BytecodeLayer/Semantics/Gas.lean#L590);
  the 63/64 floor [`allButOneSixtyFourth_ge_of_liftFloor_le`](../../../EVM/BytecodeLayer/Semantics/Gas.lean#L628).
- Hoare: [`Runs.trans`](../../../EVM/BytecodeLayer/Hoare.lean#L97),
  [`messageCall_runs`](../../../EVM/BytecodeLayer/Hoare/CallSequence.lean#L68), the opcode rules
  ([`runs_push1`](../../../EVM/BytecodeLayer/Hoare.lean#L164),
  [`runs_push`](../../../EVM/BytecodeLayer/Hoare.lean#L176),
  [`runs_sstore`](../../../EVM/BytecodeLayer/Hoare.lean#L188)) and SSTORE effect/frame
  ([`sstoreFrame_storage_self`](../../../EVM/BytecodeLayer/Hoare.lean#L221),
  [`sstoreFrame_storage_frame`](../../../EVM/BytecodeLayer/Hoare.lean#L241)).

**Examples / demos** (leaves; nothing in the core consumes them)
- Call-free `*'` lemmas in [`ProgramExamples.lean`](../../../EVM/BytecodeLayer/Examples/ProgramExamples.lean)
  and their observable re-exports in [`ConcreteSpecs.lean`](../../../EVM/BytecodeLayer/Examples/ConcreteSpecs.lean#L44).
- [`hoare_demo`](../../../EVM/BytecodeLayer/Examples/HoareDemo.lean#L154) — standalone SSTORE
  demo.
- The external-call worked instance: the compositional
  [`messageCall_callerProg_runs`](../../../EVM/BytecodeLayer/Examples/CallerProgExample.lean#L186)
  → [`messageCall_callerProg_storageAt`](../../../EVM/BytecodeLayer/Examples/CallerProgExample.lean#L218),
  surfaced as the `∃G₀` spec
  [`messageCall_call_storageAt`](../../../EVM/BytecodeLayer/Examples/ConcreteSpecs.lean#L95)
...
- [`call_counterexample`](../../../EVM/BytecodeLayer/Examples/ConcreteSpecs.lean#L106): at
...
- `decide` on big concrete program terms + `set_option maxRecDepth 4000`: confined
  to the **example files** ([`CallerProgExample.lean`](../../../EVM/BytecodeLayer/Examples/CallerProgExample.lean#L44),
  [`ProgramExamples.lean`](../../../EVM/BytecodeLayer/Examples/ProgramExamples.lean#L36),
  [`HoareDemo.lean`](../../../EVM/BytecodeLayer/Examples/HoareDemo.lean#L29)) and the concrete
  fixtures of [`ExternalCall.lean`](../../../EVM/BytecodeLayer/ExternalCall.lean) /
  per-program data in [`System.lean`](../../../EVM/BytecodeLayer/Semantics/System.lean). **No
...
1. **Frame-level audit surface (flagged in [`Spec.lean`](../../../EVM/BytecodeLayer/Spec.lean#L22)).**
...
2. **Single caller/callee witness.** Only one external-call pair is exercised
   (`callerProg` CALLs `calleeProg`, [`Programs.lean`](../../../EVM/BytecodeLayer/Programs.lean#L57)).
...
3. **[`Behaves`](../../../EVM/BytecodeLayer/Hoare/Behaves.lean#L45) is defined but
