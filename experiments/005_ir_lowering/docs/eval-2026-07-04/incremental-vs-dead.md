...
| `callRealises_bridge` | CallRealises.lean:85 | v2spine | R3 `callRealises_of_recorded` (RS:1364, **open leaf**) | RecorderLemmas:41 docstring names it as the tie R3's head uses; its sibling `evmCallEntry` IS live (RS:2856) |
