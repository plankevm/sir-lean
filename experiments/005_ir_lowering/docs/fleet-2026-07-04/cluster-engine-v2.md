...
| `CallRealises.lean` | 110 | Call realisability bridge: abstract CallStream entry = lowered CALL observable | `evmV2CallEntry`, `callRealises_bridge` | V2-spine | load-bearing | `evmV2CallEntry` consumed by SimStmt + Recorder + SelfPresent; the call-side analogue of the retired gas `Oracle` |
